...
//    printf("\n");
	...
	//Hay que ver de los hilos que combinacion es mejor i printarla.
	if (CosteMejorCombinacion<CostMinim)
	{
		CostMinim = CosteMejorCombinacion;
